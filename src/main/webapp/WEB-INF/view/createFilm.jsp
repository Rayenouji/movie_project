...
<head> 
<meta http-equiv="Content-Type" content="text/html; charset=windows-1256"> <title>Ajouter Film</title> 
</head> 
<body> 
...
<form action="saveFilm" method="post"> 
 ...
 <input type="text" name="nomFilm" class="form-control"/>  </div> 
 <div class="form-group"> 
 <label class="control-label">genre Film :</label> 
 <input type="text" name="genreFilm" class="form-control"/>  </div>  
 <div class="form-group"> 
